...
<body>
      ...
      <nav class="full-content" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-shape shadow-sm radius-0">
          ...
          <li class="breadcrumb-item active bg-info text-white" aria-current="page">
            <a class="link-white" href="admin/country/country.php">
              <?php echo $title_page; ?>
            </a>
          </li>
        </ol>
      ...
      <div class="container-full p-2 fs-x-14">
        <div class="row">
          ...
          <div class="col-12 mb-3">
            <a href="admin/country/country.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
              <i class="fas fa-list-ul"></i>
              Listar
            </a>
            <a href="admin/country/nuevo.php" class="btn btn-outline-primary btn-sm btn-bar" role="button">
            ...
            <table id="dataTableList" class="table table-striped table-bordered" style="width:100%">
              ...
              <tbody>
                ...
                <tr class="<?php echo $class_estado ;?>" >
                  ...
                  <td> <?php echo $row->topLevelDomain ?> </td>
                  <td> <?php echo $row->capital ?> </td>
                  <td> <?php echo $row->region ?> </td>
                  <td> <?php echo $row->subregion ?> </td>
                  <td> <?php echo $row->alpha2Code ?> </td>
                  <td> <?php echo $row->alpha3Code ?> </td>
                  <td> <?php echo $row->callingCodes ?> </td>
                  <td> <?php echo $row->population ?> </td>
                  <td> <?php echo $row->latitud ?> </td>
                  <td> <?php echo $row->longuitud ?> </td>
                  <td> <?php echo $row->demonym ?> </td>
                  <td> <?php echo $row->area ?> </td>
                  <td> <?php echo $row->timezones ?> </td>
                  <td> <?php echo $row->nativeName ?> </td>
                  <td> <?php echo $row->numericCode ?> </td>
                  <td> <?php echo $row->flag ?> </td>
                  <td> <?php echo $row->cioc ?> </td>

                  <td class="text-center">
                    <a class="btn btn-outline-primary btn-sm lh-1 btn-table <?php echo $class_disabled ; ?>" href="admin/country/editar.php?id=<?php echo $row->id ?>" title="Editar">
  ...
  (function ($) {
    function processFormModal(event) {
      ...
      $.ajax({
        url: "./app/api/country/IndexCountry.php",
        dataType: "json",
        type: "post",
